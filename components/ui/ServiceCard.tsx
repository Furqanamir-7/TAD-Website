...
export function ServiceCard({ number, title, description, href }: ServiceCardProps) {
  return (
    <Link 
      href={href}
      className="group block p-8 border border-[var(--color-accent-line)]/30 bg-[var(--color-box-bg)] text-white hover:bg-[var(--color-bg-sec)] hover:text-[var(--color-text-sec)] transition-all duration-500 ease-[cubic-bezier(0.25,0.46,0.45,0.94)]"
    >
