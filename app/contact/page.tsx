    ...
    <main className="min-h-screen pt-32 pb-20">
      <Container>
         ...
         <div className="flex flex-col lg:flex-row h-full min-h-[600px] border border-[var(--color-accent-line)]/20 shadow-xl">
             ...
             {/* Right: Form (Light) */}
             <div className="w-full lg:w-3/5 bg-white p-12 lg:p-16">
                 <form className="space-y-12" onSubmit={(e) => e.preventDefault()}>
                     ...
                     <div>
                         ...
                         <textarea 
                            className="w-full h-32 border-b border-[var(--color-accent-line)] bg-transparent resize-none p-2 focus:outline-none focus:border-black transition-colors"
