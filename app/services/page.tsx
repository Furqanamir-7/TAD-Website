        ...
        <div className="space-y-0 border-t border-[var(--color-accent-line)]/30">
          {SERVICES.map((service) => (
            <Link 
              ...
              className="group flex flex-col md:flex-row items-baseline md:items-center justify-between py-12 border-b border-white/20 bg-[var(--color-box-bg)] text-white px-8 -mx-8 transition-all duration-500 ease-[cubic-bezier(0.25,0.46,0.45,0.94)]"
            >
